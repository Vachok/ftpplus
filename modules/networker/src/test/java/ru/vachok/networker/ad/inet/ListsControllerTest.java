    ...
    public void testGetInfoAbout() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            Assert.assertTrue(Stream
                .of("10.", "212.45.3.116", "", "mail.yandex", "93.158.134.0/24", "81.222.128.0/24", "windowsupdate", "8.8.8.8", "image/jpeg", "gostexpert", ConstantsFor.ISTRANET, "192.", "yandsearch", "46.17.203.51/16")
